...
For incident reports, provide version `0.2.3`, the invoked visible skill, and a sanitized reproduction. Remove session identifiers, turn tokens, trace data, collection identifiers, viewer destinations, source content, personal information, and authentication details.
